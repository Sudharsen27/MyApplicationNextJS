...
//             <motion.span whileHover={{ scale: 1.1 }}>Logo</motion.span>
//           </Link>
...
//               >
//                 <Link href={item.path} className="text-gray-800 hover:text-pink-500 transition-colors">
//                   {item.name}
//                 </Link>
//               </motion.div>
//             ))}
...
//             className="md:hidden mt-4 bg-white/90 backdrop-blur-md shadow-lg rounded-lg p-4 absolute left-6 right-6"
//           >
...
//                 >
//                   <Link href={item.path} className="text-gray-800 block py-2 hover:text-pink-500 transition-colors">
//                     {item.name}
//                   </Link>
//                 </motion.div>
//               ))}
