...
staggerElements.forEach((el, index) => {
  ...
  (el as any).style.transitionDelay = `${index * 0.15}s`;
  // OR
        ...
        >
          <div className="overflow-hidden rounded-lg perspective">
            <img 
              ...
              className="max-w-xs mx-auto transition-all duration-700 ease-in-out hover:rotate-3d" 
              style={{
        ...
        >
          <div className="overflow-hidden rounded-lg">
            <img 
              ...
              className="max-w-xs mx-auto filter transition-all duration-700 ease-in-out hover:saturate-150 hover:brightness-110" 
            />
          </div>
          <div className="w-24 h-1 bg-amber-300 mt-4 mx-auto transform origin-left transition-all duration-500 group-hover:w-full"></div>
        </div>
